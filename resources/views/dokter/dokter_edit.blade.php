                    ...
                    <form action="/admin/dokter/{{ $dokter->id }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_dokter"
                                ...
                                is-invalid
                            @enderror" id="nama_dokter" value="{{ $dokter->nama_dokter }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="spesialis"
                                ...
                                is-invalid
                            @enderror" id="spesialis" value="{{ $dokter->spesialis }}">
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" name="alamat" rows="10">{{ $dokter->alamat }}</textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" id="no_telp" value="{{ $dokter->no_telp }}">
                            <div class="invalid-feedback">
